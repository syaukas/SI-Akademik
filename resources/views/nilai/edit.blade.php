    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('nilai/'.$nilai->id.'/update') }}" method="post"> @csrf @method("PUT")
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="js-example-basic-single form-control form-control-lg" name="mahasiswas_id">
                                    ...
                                    @foreach ($mahasiswas as $row)
                                        <option {{  $nilai->mahasiswas_id == $row->id ? 'selected' : '' }} value="{{ $row->id }}">{{ $row->name }} - {{ $row->nim }}</option>
                                    @endforeach
                                  </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="js-example-basic-single form-control form-control-lg" name="matkuls_id">
                                    ...
                                    @foreach ($matkuls as $row)
                                        <option {{  $nilai->matkuls_id == $row->id ? 'selected' : '' }} value="{{ $row->id }}">{{ $row->name }} - {{ $row->dosen->name }}</option>
                                    @endforeach
                                  </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group my-3">
                                    ...
                                    <input type="number" class="form-control" name="nilai_uts" value="{{ $nilai->nilai_uts }}">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-3">
                                    ...
                                    <input type="number" class="form-control" name="nilai_uas" value="{{ $nilai->nilai_uas }}">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-3">
                                    ...
                                    <select class="js-example-basic-single form-control form-control-lg" name="unit">
                                        ...
                                        @for ($i = 1; $i < 7; $i++)
                                            <option {{  $nilai->unit == $i ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                      </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group my-3">
                                    ...
                                    <select class="js-example-basic-single form-control form-control-lg" name="tahun_ajar">
                                        ...
                                        @for ($i = 2019; $i < 2025; $i++)
                                            <option {{  $nilai->thn_ajar == $i . ' / ' . ($i+1) ? 'selected' : '' }} value="{{ $i . ' / ' . ($i+1) }}">{{ $i . ' / ' . ($i+1) }}</option>
                                        @endfor
                                      </select>
                                </div>
